\chapter{Einleitung}
    ...
    Bei diesem Prozess entfällt die Joulsche Wärme, da Spinwellen kein Transport von Elektronen, wie bei herkömmlichen auf Halbleiter basierenden Komponenten stattfindet~\cite{AFM_3}.
    ...
    Dies betrifft besonders die Energiedifferenz zwischen Fermi und HOMO beziehungsweise LUMO, welche ein entscheidender Schlüssel für die Anwendung darstellt~\cite{5A_4}.
    ...
    % Ansatz und Systeme
    Nachdem für chemisorbierte Moleküle auf Ferromagneten bereits Spin polarisierte Zustände gefunden wurden \cite{IF_16} ergeben auch erste theoretische Berechnungen dies für antiferromagnetische Oberflächen.
