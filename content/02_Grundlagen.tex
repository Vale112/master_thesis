    ...
    \section{Wechselwirkung von Oberfläche mit Molekülen} \label{sec:WW}
        ...
        \subsection{Selbstanordnung} \label{sec:Selbstanordnung}
            ...
            \begin{figure}
                ...
                Die Bilder (a), (c) und (e) entsprechen einer Bedeckung von einer Monolage, die Bilder (b), (d) und (f) einer Bilage Pentacen.
    ...
    \section{Systemeigenschaften} \label{sec:Systeme}
        ...
        \subsection{Pentacen} \label{sec:5A}
            ...
            \begin{figure}
                ...
                \caption{Geometrische Struktur des Pentacen sowei die vier höchsten besetzten und vier niedrigesten unbesetzen Orbitale. Vorlage aus~\cite{PEN}.}
                \label{fig:PEN}
            \end{figure} 
