\chapter{Grundlegende Eigenschaften}
    ...
    \section{Übergangsmetalloxide} \label{sec:TMO}
        ...
        Eine flächenzentrierte Struktur wie auch die Spinellstruktur wird für einige Oxide angenommen, die auf dem selben Übergangsmetall beruhen~\cite{FeO_26}.
        ...
        Im Gegensatz zu Volumen kristallinen Eigenschaften sind die Eigenschaften von dünnen Filmen und Oberflächen bislang wenig erforscht.
    ...
    \section{Wechselwirkung von Oberfläche mit Molekülen} \label{sec:WW}
        ...
        \subsection{Selbstanordnung} \label{sec:Selbstanordnung}
            ...
            Eine wichtige Bindung für Wasserstoff enthaltene Moleküle ist die Wasserstoff-Brücken-Bindung mit einer Energie von \SIrange{0.01}{1.73}{\electronvolt} und kurzen Bindungslängen.
    ...
    \section{Systemeigenschaften} \label{sec:Systeme}
        ...
        Die (100)-orientierte Oberfläche des Wüstits sollte eine geringere Reaktivität als die (111)-orientierte Oberfläche zeigen, desweiteren sind auf ihr die Spins der Eisenionen abwechselnd gerichtet. % ist aufgrund der geordneten Struktur ein geeignetes Material für das Wachstum von Molekülen.
        \input{content/tab_Systeme.tex}
        Eine Übersicht über die wichtigsten Systemparameter ist in \autoref{tab:Systeme} gegeben.Ein kleines Molekül für das auf vielen Oberflächen Selbstanordnung intiiert werden kann und bereits als organischen Halbleiter eingesetzt wird, ist das Pentacen.
        ...
        \subsection{Eisenmonooxid} \label{sec:FeO}
            ...
            Die magnetischen Momente der $\ce{Fe}^{2+}$-Ionen parallel zu den (111)-Ebenen ausgerichtet, sodass sich auf der (100)-Oberfläche eine abwechselnde Spinausrichtung ergibt.
        ...
        \subsection{Pentacen} \label{sec:5A}
            Pentacen zeichnet sich durch seine hohen Elektronenmobilität von \SI{3.0}{\centi\meter\squared\volt\per\second} aus und weist damit eine größere Elektronenbeweglichkeit als jene des häufig eingesetzten Siliziums mit \SI{1.0}{\centi\meter\squared\volt\per\second} auf~\cite{5A_13}.und seine geringen Größe aus, wodurch es als organischer Halbleiter zum Einsatz gebracht wird~\cite{5A_4}.
