\chapter{Grundlagen}
    ...
    \section{Antiferromagneten}
        ...
        Hierbei ist $S^{\uparrow}, S^{\downarrow}$ der Spin der Untergitter.
    ...
    \section{Wechselwirkung von Oberfläche mit Molekülen}
        ...
        \subsection{Physisorption}
            ...
            Das eine Potential wirkt repulsiv und resultiert aus dem Pauliverbot, kommen sich Molekülorbital und Substratorbital zunah, überlappen diese.
            ...
            vermehrt tritt dies bei Halbleitern und Isolatoren auf, da die Molekülzustände in der Bandlücke liegen und so keine Bindung mit dem Substrat eigegangen werden kann~\cite{IF_1}.
        ...
        \subsection{Chemisorption}
            ...
            \begin{figure}
                \centering
                \includegraphics[width=0.6\textwidth]{./content/Chemisorption2.PNG}
        ...
        \subsection{Selbstanordnung}
            ...
            Die Keeson-Wechselwirkung als Ursache der Dipol-Dipol-Interaktion hat ebenfalls Beteiligung an der Anordnung der le, allerdings nur wenn die Moleküle ein permanetes Dipolmoment haben.
            ...
            Wasserstoff-Brücken-Bindungen sind je stärker sie werden eher geradlienig gerichtete Bindungen mit einer kurzen Bindungslänge.
            ...
            Die stärkste und gerichteste Kraft ist jedoch die covalente Bindung, welche gleichzeitig auch die elektronische Struktur stark beeinflusst.
            Sie ist sogar so stark, dass die teilweise eine perfekte Selbstanordnung behindert und damit eher zu weniger geordneten Strukturen tendieren kann \cite{IF_1}.
        ...
        Auch wenn einige Oxide Ladungsaustausch zwischen Valenzband und HOMO zulassen so  gibt es noch kein Model, dass dies beschreibt.
        ...
        Ausschlaggebend für die Energieniveau-Anpassung ist das elektrochemische Potential des Substrates mit dem Reduktionspotentials des Moleküls. \textbf{<->}
        Beeinflusst wird dies weiter noch durch die Differenz zwischen der Austrittsarbeit des Substrates und der Ionisationsenergie.
        Als Ionisationsenergie wird die Energie zwischen höchsten bestztem Molekülorbital (HOMO, \textit{highest occoupied molecular orbital}) und dem Vakuumlevel unterschieden.
        ...
        Wegen des Pauliverbot und den zusätzlichen Elektronen der Moleküle an der Grenzfläche werden die Elektronen an der Oberfläche in den Festkörper zurück gedrenkt und tritt somit immer auf~\cite{IF_4}.
        Durch den so gennanten \textit{Push-Back}-Effekt wird des Oberflächendipolmoment reduziert~\cite{IF_1}.
        ...
        Hinzukommend gibt es gegebenfalls noch einen permanetnetn Dipol des Moleküls, welcher beachtet werden muss.
