\chapter{Grundlagen}
    ...
    \section{Substrate und Molekül Eigenschaften}
        ...
        \begin{figure}
            ...
            \caption{Die Krsiatllstruktur von Magnetit. Aus \textbf{Bertram - 2009 - Röntgenstrukturanalyse von Oxidschichten.pdf}}
            \label{fig:Spinell}
        \end{figure}
            ...
            \begin{itemize}
                ...
                \item Bandlücke \SI{0.1}{\electronvolt} \textbf{Park et al. - 1999 - A New Synthetic Route to Wüstite.pdf} Bei Raum Temperatur
                \item unter 125K soll Phasenwechsel stattfinden -> Leitend??? \textbf{Zimmermann 16 und 57} wird es mehr leitend oder isolierend?
                \item Vielversprechend für den Einsatz in MTJs als Elektrodenmaterial ist das ferrimagnetische
                halbmetallische Eisenoxid Magnetit (Fe3O4), dem eine einhundertprozentige Spinpolarisation
                an der Fermi-Kante und damit ein theoretisch unendliche großer TMR-Effekt
                zugewiesen wird. Darüber hinaus liegt die Curie-Temperatur mit 858K weit über der
                Raumtemperatur [9]. \textbf{Anfangsstadium des epitaktischen Wachstums von MgO auf Fe3O4 (001)-Schichten}
                \item ferromagetisches Halbmetall mit Curie-Temperatur von \SI{858}{\kelvin} und \SI{100}{\percent} Spinpolarisation \textbf{Arora et al. - 2005 - Magnetoresistance enhancement in epitaxial magneti.pdf}
                \item Anwendung in Magnetbändern und als Katalysator \textbf{Zimmermann - 2010 - Epitaktisches Wachstum und Charakterisierung ultra.pdf}
                \item (100) Orientierung hat $(1\times 1)\text{R}\SI{45}{\degree}$ Oberflächen Einheitszelle mit $\frac{a}{\sqrt{2}}$ Kantenlänge \textbf{Buß - 2015 - Studies on the Epitaxial Growth of Ultrathin Metal.pdf}
                \item Im gegensatz zu den anderen Eisenoxiden zeigt die Oberfläche eine $(\sqrt{2}\times\sqrt{2})$R\SI{45}{\degree} Rekonstruktion der (100)-Orientierung \textbf{Ruwisch - 2016 - VSM-Untersuchung magnetischer Eigenschaften von ep.pdf}
                \item 
            \end{itemize}
        ...
        \subsection{Eisenmonooxid}
            ...
            Genauer wie schon das \ce{Fe3O4} und \ce{NiO} ist auch \ce{FeO} ein Ladungstransfer Isolator mit einer Bandlücke von \SI{2.4}{\electronvolt}~\cite{FeO_21}.

            \ce{FeO} ist nur oberhalb von \SI{560}{\celsius} stabil.
        ...
        \subsection{Pentacene} \label{sec:5A}         
            ...
            Pentacene findet auf Grund seiner Größe und dabei hohen Elektronenbeweglichkeit Anwendung in elektronischen Bauteilen als organischer halbleiter.
