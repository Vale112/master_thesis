\chapter{Grundlegende Eigenschaften}
    ...
    \section{Antiferromagnetismus} \label{sec:AFM}
        ...
        \begin{figure}[H]
            ...
            \caption{Schematisierung der antiferromagnetischen Kopplung.
    ...
    \section{Wechselwirkung von Oberfläche mit Molekülen} \label{sec:WW}
        ...
        \subsection{Physisorption}
            ...
            Da die Wechselwirkung bei der Physisorption nur gering ist werden die Eigenschaften der Oberfläche und des Moleküls nur schwach beeinflusst~\cite{bergenti_spinterface_2019}.
        ...
        \subsection{Energieniveauanpassung} \label{sec:ENA}
            ...
            Wegen des Pauliverbot und den zusätzlichen Elektronen der Moleküle an der Grenzfläche werden die Elektronen an der Oberfläche in den Festkörper zurückgedrängt.
    ...
    \section{Systemeigenschaften} \label{sec:Systeme}
        ...
        \subsection{Nickeloxid} \label{sec:NiO}
            \begin{figure}
                ...
                \caption{Die Kristallstruktur von Nickeloxid. Das $\ce{Ni}^{2+}$ Ion befindet sich in einer oktaedrischen Umgebung von $\ce{O}^{2-}$ Ionen. Aus~\cite{NiO-structure}.}
        ...
        \subsection{Magnetit} \label{sec:Fe3O4}
            ...
            In Bezug auf die Oberflächeneinheitszelle des Eisens zeigt die \ce{Fe3O4} Oberfläche ein unrekonstruierte $\text{p}(2\times 2)$ Überstruktur (siehe \autoref{fig:LEED_Sub}(b)), da die primitive Einheitszelle der Oberfläche eine Gitterkonstante von \SI{5.9}{\angstrom} besitzt.
