\chapter{Grundlagen}
    ...
    Eine Einführung und Überblick über die verwendeten Systeme werden in \autoref{sec:Systeme} gegeben.
    ...
    \section{Übergangsmetalloxide} \label{sec:TMO}
        ...
        Ihre elektrische Leitfähigkeit reicht von Hochtemperatur supraleitende über leitend und halbmetallisch bis hin zu isolierend~\cite{IF_5}.
        ...
        Die chemischen und elektrochemischen Eigenschaften der Filme hängen maßgeblich vom Präperationsprozess ab und können zu unterschiedlichen Ergebnissen und damit Eigenschaften führen~\cite{Uni-Tübingen}.
        Durch gezieltes Eingreifen in den Präperationsprozess, z.B. durch Variation des Verhältnisses aus Sauerstoffdruck und Aufdampfrate, lässt sich die Stöchiometrie variieren.
    ...
    \section{Antiferromagnetismus} \label{sec:AFM}
        ...
        \begin{figure}
            ...
            \caption{Schamtisierung der antiferromagnetischen Kopplung.
    ...
    \section{Wechselwirkung von Oberfläche mit Molekülen} \label{sec:WW}
        ...
        Die schwächer Adsorption ist die Physisorption, die stärkere die Chemisorption, welche wiederum in stark und schwach unterschieden wird.
        ...
        \subsection{Selbstanordnung} \label{sec:Selbstanordnung}
            ...
            \begin{figure}
                ...
                Direkt oberhalb eines Substratatoms (\textit{on top} - t), zwischen zwei Substratatomen mit kleinem Abstand (b) und großem Astand (b'), den Brückenplätze (\textit{bridge}).
        ...
        \subsection{Energieniveau-Anpassung} \label{sec:ENA}
            ...
            Wegen des Pauliverbot und den zusätzlichen Elektronen der Moleküle an der Grenzfläche werden die Elektronen an der Oberfläche in den Festkörper zurück gedränkt.
    ...
    \section{Systemeigenschaften} \label{sec:Systeme}
        ...
        \subsection{Nickeloxid} \label{sec:NiO}
            ...
            Problematisch an dünnen Filmen von Nickeloxid in der (111)-Orientierung ist dessen Instabilität und die starke Abhängigkeit vom Präperationsprozess~\cite{NiO_36}.
        ...
        \subsection{Magnetit} \label{sec:Fe3O4}
            ...
            Die \ce{Fe3O4} Oberfläche zeigt ein unrekonstruierte $\text{p}(2\times 2)$ Überstruktur (siehe \autoref{fig:LEED_Sub}(b)), da die primitive Einheitszelle der Oberfläche eine Gitterkonstante von \SI{5.9}{\angstrom} besitzt.
        ...
        \subsection{Pentacen} \label{sec:5A}
            ...
            \begin{figure}
                ...
                \label{fig:PEN}
            \end{figure} 
            Bei Pentacen ($\ce{C22H14}$) oder auch kurz 5A handelt es sich um einen Elektronendonator und gehört zu den p-Typ Halbleiter~\cite{5A_1}. % Transport wird maßgeblich durch Löcher verursacht.
