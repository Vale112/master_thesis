\chapter{Grundlagen}
    ...
    \section{Substrate und Molekül Eigenschaften}
        ...
        \subsection{Eisenmonooxid (100) Oberfläche}
            ...
            Dabei beträgt die Gitterkonstante \SI{4.308}{\angstrom}~\cite{springer_database} und die $\ce{Fe}^{2+}$-Ionen befinden sich einer oktraedischen Position zum Suaerstoff~\cite{FeO_4}.
