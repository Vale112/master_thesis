\chapter{Methoden und Techniken} \label{cha:Methoden}
    ...
    \section{Photoelektronenspektroskopie} \label{sec:PES}
        ...
        Hier tritt auch der Effekt auf, dass die Periodizität des Festkörpers verlassen wird und somit die senkrechte Komponente des Impulsvektors nicht erhalten bleibt.
        Dabei bleibt aber der Impulsvektor parallel zur Oberfläche $k_{||}$ erhalten.
        ...
        \subsection{Röntgenabsorptionspektroskopie - XAS}
            ...
            So lässt sich aus den Unterschieden der Absorptionsintensitäten für s- und p-polarisiertem Licht die Neigung von Molekülen auf der Oberfläche kalkulieren. \textbf{Quelle 65 Hennings Disserattion}
            Für zirkularpolarisiertes Licht ergibt sich aus dem Intensitätsunterschied der links- und rechtszirkularpolarisertem Licht die Magnetisierung.
        ...
        \subsection{Winkelaufgelöste Photoelektronenspektroskopie - ARPES} \label{sec:UPS}
            ...
            Für jede Winkelkombination wird ein UPS Spektrum aufgezeichnet.
            Der entsprechnde Impulsvektor lässt sich dann aus den Winkeln und der kinetischen Energie nach
            \begin{gather}
    ...
    \section{2D Photoelektronen Mikroskopie} \label{sec:2D-PES}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.7\textwidth]{./content/pictures/PEEM_schemaneu.png}
