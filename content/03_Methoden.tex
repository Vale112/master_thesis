\chapter{Methoden und Techniken} \label{cha:Methoden}
    ...
    Die Photoelektronenspektroskopie erlaubt Rückschlüsse auf die chemische Zusammensetzung und die elektronische Beschaffenheit der untersuchten Oberfläche.
    ...
    \section{Photoelektronenspektroskopie} \label{sec:PES}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.5\textwidth]{EDC_DJ.pdf}
        ...
        \subsection{Das drei Stufenmodell} \label{sec:3Stufen}
        ...
        \subsection{Winkelaufgelöste Photoelektronenspektroskopie - ARPES} \label{sec:ARPES}
            ...
            \begin{figure}
                \centering
                \includegraphics[height=5cm]{ARPES.pdf}
    ...
    \section{Photoelektronenemissionsmikroskopie} \label{sec:PEEM}
        ...
        Zuerst wurde dies 1933 durch E. Brüche entdeckt, der eine Realraumaufnahme einer Zinkplatte mit Hilfe von Photoelektronen, einer Extraktor-Linse und einer magnetischen Linse auf einem Leuchtschirm abbildete~\cite{bruche_elektronenmikroskopische_1933}.
        ...
        \begin{figure}
            \centering
            \includegraphics[width=0.6\textwidth]{Real_k_2.PNG}
        ...
        Im vorderen Teil, dem PEEM (\textit{Photoemitted electron microscopy}), ändert sich nichts wohingegen die Transferlinse dafür sorgt, dass entweder das Realraum- oder Beugungsbild auf die Eintrittsblende des Analysators abgebildet wird.
    ...
    \section{Photoemissionsorbitaltomographie} \label{sec:MOT}
        ...
        \begin{figure}
            ...
            Die durch die Fouriertransformation gewonnen Orbitalstruktur im reziproken Raum (\subref{fig:DFT2}).
