\chapter{Ergebnisse}
    ...
    \section{Nickeloxid} \label{sec:Prep_NiO}
        ...
        Dies führt zu einer wohldefinierten, sauberen Oberfläche was sich auch anhand der scharfen Spots im LEED-Bild erkennen lässt (\autoref{fig:LEED_Au}).
        ...
        Im Bereich zwischen \SIrange{2}{6.2}{\electronvolt} befinden sich die fünf d-Bänder, welche durch ihre flache Form aufgrund der Lokalisierung der Elektronen erkennbar ist.
        ...
        \begin{figure}
            ...
            \label{fig:Fermi_Au}
        \end{figure}
        Die Bindungsenergie wird mithilfe eines Fits der Fermikante in dem winkelintegrierten Spektrum (\textit{energy distribution curve}, EDC) aus \autoref{fig:Fermi_Au} ermittelt.
        ...
        \end{figure}
        Durch die Variation der Aufdampfzeiten lassen sich zwei verschiedene Schichtdicken von ca. \SI{15.7}{\angstrom} und \SI{36.7}{\angstrom} erzeugen.
        ...
        Dennoch liegt die Austrittsarbeit des dicken Nickeloxidfilms im erwarteten Bereich von \SIrange{4.5}{5.2}{\electronvolt}~\cite{poulain_electronic_2020}.
    ...
    \section{Pentacen auf Nickeloxid und Eisenmonooxid} \label{sec:Ergeb}
        ...
        \subsection{Pentacen auf Eisenmonooxid}
            ...
            Die rührt von der Substratsymmetrie her, da sich atomare Reihen entlang der Substratachsen ergeben und sich die Moleküle an diesen ausrichten.
            ...
            Charakteristisch ist ein quadratähnliche Intensitätsverteilung, welche um \SI{45}{\degree} relativ zur $k_\text{y}$-Achsen verdreht ist.
