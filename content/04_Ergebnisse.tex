\chapter{Ergebnisse}
    ...
    Die Nickeloxidfilm wurden alle in dem Versuchsaufbau aus \autoref{sec:Versuchsaufbau} vorbereitet und vermessen.
    ...
    Das zweite Substrat, das Eisenmonooxid wurde an der NanoESCA Beamline am Synchrotron Elettra in Triest präperiert und charakterisiert \footnote{Näheres zu diesem Versuchsaufbau und der Behandlung der Daten kann in~\cite{ma-DJ} gefunden werden.}.
    Die Details dieses Prozesses sind in \autoref{sec:Prep_FeO} zusammen gefasst.
    Auf beide Substrate wurden dann Pentacene Molekühle aufgedampft und mittels der Beugung niederenergetischer Elektronen sowie der Moleküle Orbitale Tomographie betrachtet.
    ...
    \section{Präperation Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        Diese ist dabei ein dünner Film auf Magnesiumoxid(100).
        Auf diese wird dann ein Film Magnetit aufgedampft und mittels Heizen und ioneninduziertes Zerstäuben in Eisenmonooxid umgewandelt.
        ...
        Hierbei ist die gemessene Halbwertsbreite mit \SI{2.11}{\electronvolt} etwas größer. % , wobei die Probe auch bei Raumtemperatur vermessen wurde.
        ...
        Anaschließend wird die Probe kurz auf \SI{600}{\celsius} aufgeheizt.
        ...
        Aus dem Abschnitt der Sekundärelektronen lässt sich die Austrittsarbeit der paasivierten Eisenprobe auf \SI{4.06}{\electronvolt} bestimmen.
        ...
        Die Auflössung und Messstatistik lässt es allerdings nicht zu einzelne Bänder aufzulösen, auch wenn die winkelaufgelöste Messung in \autoref{fig:BZ_Fe} sehr gut aufgelöst ist.    
        ...
        \begin{figure}
            ...
            Sowie das Beugungsbild der modifizierten Oberfläche bei einer Elektronenenergie von \SI{125}{\electronvolt}.bei einer Elektronenenergie von \SI{125}{\electronvolt}.}
        \end{figure}
        ...
        Ebenso zeigt das Augerspektrum mit dem bereits von Carpa u.A.~\cite{FeO_1} entdecken Augerelektronenspektrum für Eisenoxid zeigt gute Übereinstimmung.
        ...
        \begin{figure}
            ...
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=5.5cm]{FeO/VB_FeO.png}
                \subcaption{}
                \label{fig:EDC_FeO}
            \end{subfigure}
        ...
        Ein kleine Vererschiebung bei den Spitzen kann durch die Evaluation der Fermikante herrühren.
        ...
        Das Valenzbandspektrum des modifizierten Fimls in \autoref{fig:EDC_FeO} (grün) zeigt im niederenergetischen Bereich recht gute Übereinstimmung mit der Literatur (schwarz)~\cite{FeO_14}.
        ...
        \begin{figure}
            ...
            Links zu sehen in (\subref{fig:XPSO1s_Fe3O4}) ist der aufgedampfte Film und rechts in (\subref{fig:XPSO1s_FeO}) der Modifizierte.}
            \label{fig:XPS_O1s}
        \end{figure}
        ...
        Der \ce{OH}-Anteil liegt ebenfalls unterhalb \SI{0.9}{\electronvolt} unterhalb des erwarteten Wertes von \SI{531.5}{\electronvolt}~\cite{wandelt_photoemission_1982}.
        Ursache könnte sein, dass es an einer Refernzmessung zur Bestimmung der Photonenenergie fehlt, welche mit \SI{650}{\electronvolt} angenommen wurde und damit zu einer konstanten Verschiebung.
        ...
        Da zwischen den beiden Messungen am Monochromator die Gitter getauscht wurden sind leichte unterschiedliche Shifts in der Photonenenergie anzunehmen.
        Dies würde auch den relativen Shift der beiden Peaks von \SI{0.5}{\electronvolt} untereinander erklären, welcher nicht erwartet wird~\cite{FeO_9, FeO_64, FeO_15, wandelt_photoemission_1982}.
        ...
        \begin{figure}
            ...
            In (\subref{fig:XPSFe3p_Fe3O4}) das Spektrum des aufgedampften Films, sowie des modifizierten in (\subref{fig:XPSFe3p_FeO}).}
            \label{fig:XPS_Fe3p}
        \end{figure}
        ...
        Für den $\ce{Fe}^{3+}$-Beitrag ergeben sich dann noch \SI{40}{\percent}.
        Bei Magnetit sollte diese Verhältnis bei 1:1 liegen.

        Bei dem behandelten Film zeigt sich eine Verschmalerung der Gesamtintensität.
        ...
        Erneut lässt sich ein relative verschiebung der Bindungsenergien zum unbehandelten Film sehen, dies ist ebenfalls durch den Wechsel des Gitters zu erklären und liegt im selben Größenbereich von wenigen Elektronenvolt Zehnteln.
        ...
        Ein Vergleich mit der Literatur zeigt, dass zwischen dem $\ce{Fe}^{2+}$-Signal und $\ce{Fe}^{3+}$-Signal eine Verschiebung von etwa \SI{1.8}{\electronvolt} einstellt~\cite{FeO_15, FeO_12}.
        ...
        Auch mit unter verschieben Kompositionen verschiedene Positionen hervorrufen \cite{FeO_12}.
        Ein weitere Fehlerquelle könnte die Wahl der Asymmetrie und Anzahl der verwendeten Voigt-Funktionen sein.
        Manche Quellen sagen sechs Peaks voraus~\cite{FeO_14, FeO_17, FeO_15} wegen der Feinstruktur, andere zwei (Fe2+, Fe3+)~\cite{FeO_15, FeO_11, FeO_10, FeO_7} oder drei (Fe2+, Fe3+tetra, Fe3+octa)~\cite{FeO_12} oder auch vier um die Spin-Bahn-Aufspaltung mit etwa \SI{1}{\electronvolt} einzubeziehen~\cite{FeO_55}.
        Die Asymmetrie kann durch Mehrfachionisation bei innere Prozesse wie Augerzerfall oder durch mehrere Photonen begründet werden~\cite{FeO_55}.
        ...
        Ebenso lässt sich die Spin-Bahn-Aufspaltung des $\ce{Fe}_{3p}$ nicht auflöseb, da 1/2 und 3/2 nur etwa 1eV auseinander liegen~\cite{FeO_55}.

        \begin{figure}
            \centering
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=6cm]{Fe3O4/XAS_Fe3O4_cp.png}
                \subcaption{}
                \label{fig:XAS_Fe3O4}
            \end{subfigure}
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=6cm]{FeO/XAS_FeO_cp.png}
                \subcaption{}
                \label{fig:XAS_FeO}
            \end{subfigure}
            \caption{Die Röntgenabsorptionsspektren des aufgedampften Films (\subref{fig:XAS_Fe3O4}) und des bearbeiten Films (\subref{fig:XAS_FeO}).
            ...
            \label{fig:XAS}
        \end{figure}
        Beim Vergleich zwischen dem Röntgenabsorptionsspektrums des unbehandleten Filmsin \autoref{fig:XAS_Fe3O4}, sowie des behandleten Films in \autoref{fig:XAS_FeO} fällt auf, dass sich das Signal der $\text{L}_3$-Absorptionskante zu kleineren Photonenenergie hin verschoben hat.
        Die Verschiebung beträgt etwa \SI{0.4}{\electronvolt} und ist korreliert mit dem Oxidationszustand \cite{chen_nexafs_1997}.
        Mit steigendem Oxidationszustand steigt ebenfalls auch die Absorptionsenergie des $\text{L}_3$-Übergangs.
        Erkennbar ist, dass sich der $\ce{Fe}^{2+}$-Anteil erhöht und gleichfalls sich der $\ce{Fe}^{3+}$-Anteil verringert hat durch die Behandlung.
        Denn der Beitrag bei \SI{707}{\electronvolt} wurde für \ce{FeO} mit einer leichter Schulter zu \SI{709}{\electronvolt} beobachtet~\cite{FeO_45}.
        ...
        Die allegemeine Struktur dieser Spektren ist recht schwierig zu beschreiben und unterscheidet sich deutlich bei unterschiedlichen Oxiden~\cite{FeO_46}.

        Im Zusammenspiel der zur Charakterisierung genutzten Methoden lässt sich wohl sagen, dass es sich bei dem direkt aufgedampften Film um keine sauber präperierte Magnetit Oberfläche handelt.
        ...
        Hier gegen steht das Wüstit, welches nur leichte Abweichungen zu den Erwartungen bei den unterschiedlichen Messmethoden zeigt.
        Auf Grund der metastabilen Phase bei Raumtemperatur und tendenziellen nicht-tochimetrischen Verbindung lassen sich diese aber tolerieren.
        ...
        Zusammenfassend lässt sich sagen, dass der modifizierte Film sich als \ce{FeO} identifizieren lässt, wohingegen es sich bei dem direkt aufgedampft Film wohl um eine Mischphase handelt und nicht um reines Magnetit.
    ...
    \section{Molekühle auf Antiferromagneten} \label{sec:Ergeb}
        ...
        \begin{figure}
            ...
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=6cm]{NiO+5A/2021_06_18_005_NiO111_5A_16eV.png}
                \subcaption{}
                \label{fig:LEED_NiO+5A_16}
            \end{subfigure}
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=6cm]{NiO+5A/2021_06_18_003_NiO111_5A_73eV.png}
                \subcaption{}
                % Die Bandstruktur des reinen Eisens entlang einiger Hochsymmetrierichtungen.
                % Verwendete Photonenenergie war \SI{64}{\electronvolt} und die Polarisation p.
        ...
        \begin{figure}
            ...
            \caption{Das winkelaufgelöstes Bild bei einer Bindungsenergie von \SI{3.85}{\electronvolt} für Pentacene auf dicken Nickeloxidfilm} % bei einer kinetischen Energie von \SI{7.5}{\electronvolt}. Also Bindungsenergie von \SI{3.85}{\electronvolt}.
