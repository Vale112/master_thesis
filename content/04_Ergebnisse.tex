\chapter{Ergebnisse}
    ...
    \section{Präperation Nickeloxid} \label{sec:Prep_NiO}
        ...
        \end{figure}
        Durch Variation der Aufdampfzeiten lassen sich verschiedene Schichtdicken von Nickeloxidfilmen realisieren.
        ...
        Hinzukommend können Adsorbate, wie bei der \ce{OH-}-Terminierung die Austrittsarbeit weiter verringern~\cite{NiO_40}.
        ...
        Eigentlich lässt sich auf Grund der Schichtdicke und aus den integrierten Spektren nicht erkennen, dass Gold noch einen Beitrag leistet.
    ...
    \section{Präperation Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        Besonders schnelles Herabkühlen soll die Stochimetrie erhöhen und samit die Fraktorisierung in \ce{Fe} und \ce{Fe3O4}-Fehlstellen unterbinden~\cite{parkinson_iron_2016}.
    ...
    \section{Molekühle auf Antiferromagneten} \label{sec:Ergeb}
        ...
        Bestätigen lässt sich dies mittels der winkelaufgelösten Bilder der Molekülorbitaltomographie.
        ...
        \end{figure}
        Im Gegensatz zu dem Nickeloxid zeigt das Wüstit trotz der Abwesenheit eines klaren Beugungsbildes Molekülmerkmale bei der Molekülorbitaltomographie.
