\chapter{Ergebnisse}
    ...
    \section{Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        \textbf{??? - was für eine Überstruktur}
        % Es sind klar deutlich mehr Spots zu erkennen, die auf eine \textbf{???} Überstruktur hindeuten.
    ...
    \section{Molekühle auf Antiferromagneten} \label{sec:Ergeb}
        ...
        \begin{figure}
            ...
            \caption{Das winkelaufgelöstes Bild bei einer Bindungsenergie von \SI{3.85}{\electronvolt} für Pentacen auf dicken Nickeloxidfilm.} % bei einer kinetischen Energie von \SI{7.5}{\electronvolt}. Also Bindungsenergie von \SI{3.85}{\electronvolt}.
