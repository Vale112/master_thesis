\chapter{Ergebnisse}
    ...
    \section{Eisen}
        ...
        Die Position des $\ce{Fe}_{3\text{p}}$ Siganls passt dabei sehr gut zur Literatur mit einer Position von \SI{53.8}{\electronvolt} und einer Halbwertsbreite von \SI{1.73}{\electronvolt}~\cite{FeO_50}.
    ...
    \section{Magnetit}
        ...
        \begin{figure}
            ...
            \begin{subfigure}[t]{0.48\textwidth}
                ...
                \subcaption{Spektrum des $\ce{O}_{1\text{s}}$ Übergangs. Fit mit zwei Peaks (kleiner Shirley) sehr gut (einer O, der andere OH - Kontamination evtl vom Aufdampfen?).}
                \label{fig:XPSO1s_Fe3O4}
            \end{subfigure}
            \begin{subfigure}[t]{0.48\textwidth}
                \centering
                \includegraphics[height=5cm]{Fe3O4/Fe3p_Fe3O4.png}
                \subcaption{Spektrum des $\ce{Fe}_{3\text{p}}$ Übergang. Gleiches Problem wie beim \ce{FeO} funktioniert ebenfalls besser mit Tougaard als Shirley.}
                \label{fig:XPSFe3p_Fe3O4}
            \end{subfigure}
            \caption{Die XPS Spektren der Kernniveaus für das Magnetit.
            Für das $\ce{O}_\text{1s}$-Siganl (\subref{fig:XPSO1s_Fe3O4}) wurde eine Photonenenergie von \SI{650}{\electronvolt} und für das $\ce{Fe}_\text{3p}$-Signal (\subref{fig:XPSFe3p_Fe3O4}) eine Photonenenergie von \SI{200}{\electronvolt} verwendet.
            Die Polarisation der Strahlung ist s.}
            \label{fig:XPS_Fe3O4}
        \end{figure}
        ...
        Aus der Position des $\ce{O}_{1\text{s}}$ lässt sich nach der Literatur keine Information über das vorhandene Eisenoxid gewinnen~\cite{FeO_9, FeO_64, FeO_15}.
        Die ermittelte Position von \SI{529.2}{\electronvolt} liegt dabei immer leicht unterhalb der erwarteten Position des Siganls bei \SI{529.7}{\electronvolt}.
        ...
        Allerdings ist aus der Literatur bekannt, dass für das \ce{O}1s-Siganl keine Verschiebung zwischen den Oxiden erwartet wird.
        Somit lässt dies auch keine Identifizierung des vorhandenen Eisenoxids zu~\cite{wandelt_photoemission_1982}.
    ...
    \section{Wüstit}
        ...
        \begin{figure}
            ...
            In Schwarz ist das Spektrum der Literatur~\cite{FeO_14} bei einer Photonenenergie von \SI{65}{\electronvolt} dargestellt.}
            \label{fig:EDC_FeO}
        \end{figure}
        ...
        \begin{figure}
            ...
            \end{subfigure}
            \caption{Die Röntgenphotoelektronenspektroskopie Spektrum für den $\ce{O}_\text{1s}$-Übergang bei einer Photonenergie von \SI{650}{\electronvolt} (\subref{fig:XPSO1s_FeO}) und bei einer Photonenergie von \SI{200}{\electronvolt} der $\ce{Fe}_\text{3p}$-Übergang (\subref{fig:XPSFe3p_FeO}).
            In beiden Fällen wird s-polarisierte Strahlung verwendet.}
            \label{fig:XPS_FeO}
        \end{figure}
        ...
        \begin{figure}
            ...
            \caption{Das Spektrum Röntgenabsorptionsspektrum des Wüstit mit rechtszirkularer Polarisation.}
            \label{fig:XAS_FeO}
        \end{figure}
    ...
    \subsection{Datendeutung}
        \begin{itemize}
            ...
            \item Fe2p zeigt keinen Unterschied für Fe3+ okt/tetra~\cite{wandelt_photoemission_1982} \textbf{VORSICHT}
            \item Die Halbwertsbreite ist recht groß, da es sich bei High-Spin zuständen zur ausbildung von Multipletts kommt und diese nicht aufgelöst werden können~\cite{wandelt_photoemission_1982}
        \end{itemize}
