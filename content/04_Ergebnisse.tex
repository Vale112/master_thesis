\chapter{Ergebnisse}
    ...
    \section{Nickeloxid} \label{sec:Prep_NiO}
        ...
        Dennoch liegt die Austrittsarbeit des dicken Nickeloxidfilms im erwarteten Bereich~\cite{poulain_electronic_2020}.
        ...
        Eine eindeutige Zuordnung ob die Beiträge vom Gold und Nickeloxid kommen ist schwierig, da Nahe der Fermikante Effekte auftreten, die nicht vom \ce{NiO} herrühren können.
    ...
    \section{Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        Besonders schnelles Herabkühlen soll die Stöchiometrie erhöhen und damit die Faktorisierung in \ce{Fe} und \ce{Fe3O4}-Fehlstellen unterbinden~\cite{parkinson_iron_2016}.
    ...
    \section{Moleküle auf Antiferromagneten} \label{sec:Ergeb}
        ...
        Die Intensität sinkt, wenn der Winkel zwischen einfallenden Photonen von \SI{66}{\degree} zur Oberflächennormalen und den austretenden Elektronen sinkt.
        ...
        Die gemessenen Intensitäten in \autoref{fig:MOT_FeO+5A_exp_3} bei \SI{3.35}{\electronvolt}, liegen energetisch zwischen dem identifizieren HOMO und HOMO-2.
