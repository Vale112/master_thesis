\chapter{Ergebnisse}
    ...
    Im anschluss werden dann noch die Pentacene Moleküle aufgebracht um sie mit Hilfe der Molekülorbitaltomographie zu unterschen.
    ...
    \section{Nickeloxid}    
        ...
        Die Austrittsarbeit des dicken Nickeloxidfilms passt liegt damit im erwartetn Bereich~\cite{poulain_electronic_2020}.
        ...
        Bei größeren Energien in \autoref{fig:LEED_NiO+5A_73} hingegen sind noch leichte Substratspots sichtbar.
    ...
    \section{Eisen}
        ...
        Dadurch lässt sich für die spätere Umrechnung in die Bindungsenergie die Austrittsarbeit des Analysators bei NanoESCA auf \SI{4.5}{\electronvolt} festlegen. \textbf{nach Vitaly liegt die bei 4,25eV (kann sich aber nach dem Flashen ändern \cite{Vickerman und Gilmore - 2009 - Surface Analysis– The Principal Techniques})}
    ...
    \section{Magnetit}
        ...
        Dabei kommt es zur Umstrukturierung der Oberfläche und in Folge dessen auch zur Diffusion von Sauerstoff in Richtung des Substartes.
        ...
        Damit lässt sich dann die Konzentration des Elements $c_i = \frac{I_i/S_i}{\sum_j I_j/S_j}$ bestimmen.
    ...
    \section{Wüstit}
        ...
        Einen genaueren Einblick welche Struktur vorliegt kann die Röntgenphotoelektronenspektroskopie bieten, da hier die kinetsichen Energien so gewählt werden, dass sie Oberflächensensetiv sind.
        Das entsprechende Spektrum ist in \autoref{fig:XPS_FeO} zu finden.
        Wie erwartet zeigt sich hinsichtlich des Sauerstoffsignals keine Veränderung, wohingegen die Änderung im \ce{Fe}3p Signal deutliche Modifikationen aufweist.
    ...
    \subsection{datendeutung}
        \begin{itemize}
            ...
            \item FeO kann durch ioneninduzierte Zerstäubung aus anderen Eisenoxiden gewonnen werden, da der Wirkungsquerschnitt für Sauerstoff dabei größer ist und somit diese in der Konzentration reduziert werden. \cite{FeO_12}
                  Dann verschwinden auch Signale des Fe3+ \cite{FeO_15}, Einen Einfluss auf das FeO hat das Sputtern wohl nicht \cite{FeO_12, FeO_15}, wohl aber auf andere Oxide
            ...
            \item Normalisierung der XAS Spektren \cite{FeO_46}
            \item Unterschied bei XAS für die verschiedenen Oxide \cite{FeO_46}
            \item \cite{FeO_45} XMCD FeO trägt keinen Anteil, bei XAS tragen alle Oxide Anteile (Fe2+ stark bei 707eV und schulter bei 709eV, Fe3+ zeigt inverses Verhalten von Fe2+)
            \item Shift von Cut-off -> Dipol an der Oberfläche \cite{5A_5}
            \item Wüstit weist meist Sauerstoffmagel auf \cite{cornell_iron_2003} - warum dann das x an Fe?
