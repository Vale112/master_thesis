\chapter{Ergebnisse}
    ...
    \section{Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        Dies hat die Ursache der Vernachlässigung der Spin-Bahn-Aufspaltung von \SI{0.8}{\electronvolt} \cite{lebugle_experimentallandmcore_1981} bei der Wahl der beitragenden Voigt-Funktionen, da dies keine Vernesserung bezüglich der Anpassung mit sich brachte. % , wobei die Probe auch bei Raumtemperatur vermessen wurde.
