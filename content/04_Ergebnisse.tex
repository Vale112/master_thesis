\chapter{Ergebnisse}
    ...
    Im Anschluss werden die Pentacene Moleküle aufgebracht um sie mit Hilfe der Molekülorbitaltomographie zu unterschen.
    ...
    \section{Gold}
        ...
        Der Oberflächenzustand lässt sich in \autoref{fig:BZ_Au} klar in der Mitte erkennen.
        ...
        Dies ist vorallem für spätere Messungen des Nickeloxidfilms wichtig, da es sich hierbei um einen Isolator handelt und somit die Fermienergie in der Bandlücke liegt.
    ...
    \section{Nickeloxid}    
        ...
        Da sich ander Oberfläche der (111)-Orientierung Nickeloxid auf Grund der Polarität ein Dipolmoment ausbildet führ dies zu einer stärkeren Wechselwirkung.
    ...
    \section{Eisen}
        ...
        Durch leichtes ioneninduziertes Zerstäuben und aufheizen auf \SI{600}{\celsius} würde die Probe zunächst gereinigt.
        ...
        Die Probe wird snschließend kurz auf \SI{600}{\celsius} aufgeheizt.
        ...
        Dadurch lässt sich für die spätere Umrechnung in die Bindungsenergie die Austrittsarbeit des Analysators bei NanoESCA auf \SI{4.5}{\electronvolt} festlegen. \textbf{nach Vitaly liegt die bei 4,25eV (kann sich aber nach dem Flashen ändern \cite{vickerman_surface_2009})}
    ...
    \section{Magnetit}
        ...
        Auf Grund der Dicke des Film von etwa \SI{45}{\angstrom} ist ein Beitrag durch das Eisen-Substrat zu vernachlässigen.
        ...
        Das $\ce{O}_{1\text{s}}$-Siganl zeigt dabei einen kleinen Anteil einer $OH$ Kontamination~\cite{FeO_9}.
        ...
        Ermittelte Halbwertsbreiten hingegen passen recht gut zur Literautur von etwa \SI{1.6}{\electronvolt} und sind mit um die \SI{1.4}{\electronvolt} sogar etwas kleiner~\cite{FeO_53}.
        ...
        Im Vergleich mit der Lieteratur zeigt sich eine kleine Verschiebung hin zu einem größeren Anteil \ce{FeO} bei der $L_3$-Absorptionskante~\cite{FeO_45}.
        ...
        Da es sich nur um eine Zwischenphase zur Präperation des Eisenmonoxidhandelt wird auf eine weiter Charakterisierung und das aufbringen von Molekülen verzichtet.
    ...
    \section{Wüstit}
        ...
        Die Augerelektronen mit iherer für Eisen typischen kinetischen Energie weisen eine mittlere freie Weglänge von etwa \SI{14}{\angstrom} auf.
        Hierdurch ist die Oberflächensensetivität nicht mehr gegeben.  
        ...
        EinVergleich mit der Lieteratur zeigt die $L_3$-Kante eine kleine Verschiebung hin zu einem größeren Anteil \ce{Fe3O4}.
        ...
        Hinsichtlich dem $L_2$-Signal ist eine deutliche Übereinstimmung mit der Lieteratur zu erkennen.
