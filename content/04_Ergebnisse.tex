\chapter{Ergebnisse}
    ...
    \section{Nickeloxid} \label{sec:Prep_NiO}
        ...
        Erkennbar ist somit die Oberflächenempfindlichkeit, der verwendeten Methode, da tiefer Lagen nur noch gering zum Signal beitragen.
    ...
    \section{Eisenmonooxid} \label{sec:Prep_FeO}
        ...
        Die Reinheit der Probe lässt sich am Spektrum des $\ce{Fe}_{3\text{p}}$-Signals in \autoref{fig:XPSFe3p_Fe} erkennen.
        ...
        Hierbei ist die gemessene Halbwertsbreite mit \SI{2.11}{\electronvolt} etwas größer, dennoch im Akzeptanzbereich, da eine Spin-Bahn-Aufspaltung vernachlässigt wurde. % , wobei die Probe auch bei Raumtemperatur vermessen wurde.
        ...
        \begin{figure}
            ...
            \label{fig:XPS_O1s}
        \end{figure}
        Um genauer die Zusammensetzung zu überprüfen wird die chemisch sensitive Methode der Röntgenphotoelektronenspektroskopie angewendet.
        ...
        Dies würde deren relative Position der beiden Peaks von \SI{0.5}{\electronvolt} untereinander erklären, welcher nicht erwartet wird~\cite{FeO_15, FeO_9, FeO_64, wandelt_photoemission_1982}.
        ...
        Bei der Röntgenabsorptionsmessungen zeigt sich ein leichte Abweichung zu der aus der Literatur erwarteten Werten.
